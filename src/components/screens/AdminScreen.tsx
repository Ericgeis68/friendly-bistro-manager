...
const AdminScreen: React.FC<AdminScreenProps> = ({ 
  ...
  setCurrentScreen
    ...
    const [cookingOptions, setCookingOptions] = useState<string[]>(() => {
      ...
      return savedOptions ? JSON.parse(savedOptions) : ['BLEU', 'SAIGNANT', 'À POINT', 'BIEN CUIT'];
    });
    ...
    // Fix type casting for currentScreenLocal
    const typedSetCurrentScreenLocal = (screen: string) => {
        setCurrentScreenLocal(screen as any);
    };
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="flex">
                <Sidebar
                    currentScreenLocal={currentScreenLocal}
                    setCurrentScreenLocal={typedSetCurrentScreenLocal}
                    setSidebarOpen={setSidebarOpen}
                    sidebarOpen={sidebarOpen}
